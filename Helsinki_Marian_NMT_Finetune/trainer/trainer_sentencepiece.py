...
# 加载 tokenizer
tokenizer = SentencePieceTokenizer("./tokenizer/zh_en_mix_65001.model")
...
model.config.decoder_start_token_id = tokenizer.pad_token_id  # MarianMT使用pad_token作为decoder_start_token
...
training_args = Seq2SeqTrainingArguments(
    ...
    logging_dir='./logs',
    dataloader_num_workers=4,  # 暂时使用单进程，避免序列化问题
    dataloader_pin_memory=False,  # 单进程时不需要pin memory
